...
extension CastTCell : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let personId = castArr[indexPath.row].id
        let vc = PersonDetailsVC()
        vc.personId = personId ?? 0
