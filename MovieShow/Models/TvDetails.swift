...
//    Array(dictionary)
	...
	init(fromDictionary dictionary: [String:Any]){
        ...
        if Constants.movieOrTV == "tv"{
            ...
            originalName = dictionary["original_title"] as? String
        }
...
//
        ...
        if let prod = inProduction{
            let status = prod ? "Ongoing" : "Finished"
        ...
        //For Movies
        if let value = dictionary["budget"] as? Double{
            informationArr.append((key: "Budget", value: "\(value)"))
        }
        
        if let value = dictionary["revenue"] as? Double{
            informationArr.append((key: "Revenue", value: "\(value)"))
        }
        if let value = dictionary["release_date"] as? String{
            informationArr.append((key: "Release date", value: "\(value)"))
        }
        
        if let value = dictionary["runtime"] as? Double{
            informationArr.append((key: "Runtime", value: "\(value)"))
        }
        if let value = status{
            informationArr.append((key: "Status", value: "\(value)"))
        }
